...
String _$objectBoxServiceHash() => r'ff874b1395bc04edc9f0e6b0f2696e95f2fe2301';
...
String _$accountRepositoryHash() => r'75281e5c68aaf12e91ea99dfc6cbc3e867c2543a';
...
String _$beneficiaryRepositoryHash() =>
    r'6d2cfdc4bb374926fb5041579a07de1018daabed';
...
String _$categoryMemoryRepositoryHash() =>
    r'bf1983224f19f3bda3974f2c13d27d5e789f2393';
...
String _$categoryOverrideRepositoryHash() =>
    r'e5b8b3b7a881500b519a11ee07d0a21bf446694f';
...
String _$expenseRepositoryHash() => r'50bda22cf02d9d82581ac41e617717bbf17344c8';

@ProviderFor(legacyCategoryRepository)
final legacyCategoryRepositoryProvider = LegacyCategoryRepositoryProvider._();

final class LegacyCategoryRepositoryProvider
    extends
        $FunctionalProvider<
          ...
          LegacyCategoryRepository
        >
    with $Provider<LegacyCategoryRepository> {
  LegacyCategoryRepositoryProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'legacyCategoryRepositoryProvider',
        isAutoDispose: false,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$legacyCategoryRepositoryHash();

  @$internal
  @override
  $ProviderElement<LegacyCategoryRepository> $createElement(
    $ProviderPointer pointer,
  ) => $ProviderElement(pointer);

  @override
  LegacyCategoryRepository create(Ref ref) {
    return legacyCategoryRepository(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(LegacyCategoryRepository value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<LegacyCategoryRepository>(value),
    );
  }
}

String _$legacyCategoryRepositoryHash() =>
    r'416744a84ff6c78fc4967bb1116e8c472dd0d090';

@ProviderFor(userDataEraser)
final userDataEraserProvider = UserDataEraserProvider._();

final class UserDataEraserProvider
    extends $FunctionalProvider<UserDataEraser, UserDataEraser, UserDataEraser>
    with $Provider<UserDataEraser> {
  UserDataEraserProvider._()
    : super(
        from: null,
        argument: null,
        retry: null,
        name: r'userDataEraserProvider',
        isAutoDispose: false,
        dependencies: null,
        $allTransitiveDependencies: null,
      );
  ...
  @override
  String debugGetCreateSourceHash() => _$userDataEraserHash();

  @$internal
  @override
  $ProviderElement<UserDataEraser> $createElement($ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  UserDataEraser create(Ref ref) {
    return userDataEraser(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(UserDataEraser value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<UserDataEraser>(value),
    );
  }
}

String _$userDataEraserHash() => r'cccd45005a9101bdaf5dbde250a0349c3eb8daa4';
...
String _$loanRepositoryHash() => r'adb188f6792fff8a98b85334eaa59e1fd6289d89';
...
String _$loanEventRepositoryHash() =>
    r'55622c759f1498497d74268e854af464ef8669c3';
...
String _$revenueRepositoryHash() => r'6049708920645c98d4796d84e0c056591d8fe6fb';
...
String _$transactionEventRepositoryHash() =>
    r'd16b36a0833cfafb779cfe8039ed3c4da9e395df';
...
String _$transferRepositoryHash() =>
    r'9081581bbcd48e810699a146eb5537644029b354';
