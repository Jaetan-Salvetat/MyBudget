...
class TransferNotifier extends _$TransferNotifier {
  ...
  List<TransferModel> _currentTransfers() => state.value ?? [];

  List<TransferModel> _activeTransfers() =>
  ...
  List<TransferModel> getTransfersForAccount(int accountId) => _currentTransfers()
      .where((t) => t.fromAccountId == accountId || t.toAccountId == accountId)
      .toList();

  List<TransferModel> getActiveTransfersForAccount(int accountId) =>
      _activeTransfers()
          .where(
