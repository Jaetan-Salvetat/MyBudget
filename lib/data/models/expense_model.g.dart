...
extension ExpenseModelQueryWhereSort
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterWhere> anyName() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseModelQueryWhere
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterWhereClause> nameEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterWhereClause> nameNotEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterWhereClause> nameGreaterThan(
    String name, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterWhereClause> nameLessThan(
    String name, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterWhereClause> nameBetween(
    String lowerName,
    String upperName, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterWhereClause> nameStartsWith(
      String NamePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'name',
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterWhereClause> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'name',
        value: [''],
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterWhereClause> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension ExpenseModelQuerySortBy
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByAccountId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'accountId', Sort.asc);
    });
  }

  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByAccountIdDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByFrequency() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'frequency', Sort.asc);
    });
  }

  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByFrequencyDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseModelQuerySortThenBy
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByAccountId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'accountId', Sort.asc);
    });
  }

  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByAccountIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'accountId', Sort.desc);
    });
  }
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByFrequency() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'frequency', Sort.asc);
    });
  }

  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByFrequencyDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'frequency', Sort.desc);
    });
  }
...
extension ExpenseModelQueryWhereDistinct
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QDistinct> distinctByAccountId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QDistinct> distinctByFrequency(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseModelQueryProperty
  ...
  QueryBuilder<ExpenseModel, int, QQueryOperations> accountIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, String, QQueryOperations> frequencyProperty() {
    return QueryBuilder.apply(this, (query) {
