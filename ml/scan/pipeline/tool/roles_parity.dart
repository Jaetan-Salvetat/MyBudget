/// Rejoue les features et le tagger de rôles côté Dart, pour comparaison
/// ligne à ligne avec la référence Python (research/bench/roles_parity.py).
///
/// Entrée : les fichiers du corpus annoté, qui portent déjà les lignes
/// physiques avec leur géométrie. Sortie : par ticket, la matrice de features
/// et le rôle le plus probable de chaque ligne. Zéro divergence attendue —
/// une colonne décalée fait décider le device autrement que la référence.
library;
...
void main(List<String> args) {
  ...
  final modelPath = args
      ...
      .firstOrNull;
  if (dirs.isEmpty || modelPath == null) {
    stderr.writeln(
      'usage: dart tool/roles_parity.dart --model=<line_roles.json> <dir>...',
    );
    exitCode = 2;
    return;
  }
