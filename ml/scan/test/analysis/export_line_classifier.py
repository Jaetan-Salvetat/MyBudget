...
from line_features_v3 import FEATURE_NAMES_V3
from structure_ml import MODEL_PATHS, load_classifier

EXPORT_PATH = Path(__file__).parent / "models" / "line_clf_v3.json"
...
def main() -> None:
    ...
    if "--check" in sys.argv:
        from train_line_classifier import build_dataset
