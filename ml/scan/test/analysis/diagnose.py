...
from analyze_local_failures import ocr_amounts
from bench_flow import count_edits
from decode_constrained import decode, extract_constrained, receipt_from_labels
from line_truth import CONTRIBUTING_ROLES, ITEM, LineTruth, line_truth
from local_flow import CONFIRM, clustered_lines, decide_local
...
from structure_ml import extract_ml, load_classifier
from train_line_classifier import CLASS_NAMES, ROLE_TO_CLASS

ROOT = Path(__file__).parent.parent
DIAGNOSTICS_DIR = ROOT / "results" / "diagnostics"
TRANSCRIPT_DIRS = {
    "t1test": ROOT / "dataset_findit" / "T1-test" / "txt",
    "t1train": ROOT / "dataset_findit" / "T1-train" / "txt",
}
...
def main() -> None:
    ...
    tickets = [
        t
        for t in load_tickets(ROOT / "results" / target)
