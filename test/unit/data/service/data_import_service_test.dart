  ...
  setUp(() {
    ...
    service = DataImportService(
      ...
      eraser: UserDataEraser(
        ...
        beneficiaries: mockBeneficiaryRepo,
        categoryMemories: mockCategoryMemoryRepo,
        categoryOverrides: mockCategoryOverrideRepo,
        expenses: mockExpenseRepo,
        legacyCategories: mockLegacyCategoryRepo,
        loanEvents: mockLoanEventRepo,
        loans: mockLoanRepo,
        revenues: mockRevenueRepo,
        transactionEvents: mockTransactionEventRepo,
