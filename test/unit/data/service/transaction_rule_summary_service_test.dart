...
void main() {
  ...
  group('occurrences', () {
    ...
    test('counts an annual rule once a year', () {
      final summary = TransactionRuleSummaryService.summarize([
        version(startDate: DateTime(2024, 4, 10), frequency: Frequency.annual),
      ], asOf: DateTime(2026, 6, 20));
    ...
    test('counts a one-time rule once it has landed', () {
      final summary = TransactionRuleSummaryService.summarize([
        version(startDate: DateTime(2026, 6, 2), frequency: Frequency.oneTime),
      ], asOf: DateTime(2026, 6, 20));
  ...
  group('next due date', () {
    ...
    test('is the date itself for a one-time rule still ahead', () {
      final summary = TransactionRuleSummaryService.summarize([
        version(startDate: DateTime(2028, 9, 3), frequency: Frequency.oneTime),
      ], asOf: DateTime(2026, 6, 20));
